    ...
    <div id="container" className="flex flex-col items-center bg-black text-white h-screen w-full"  ref={container}>
      ...
      <div className="fixed top-0 left-0 h-screen z-0 size-full">
        <Canvas dpr={dpr}>
          ...
          <PerformanceMonitor onIncline={() => setDpr(2)} onDecline={() => setDpr(0.8)} />
      ...
      <section id="aboutSection" className="flex flex-col justify-center items-center z-10 absolute w-full h-full invisible">
        ...
        <div className="w-full sm:w-1/3 backdrop-blur-md rounded-xl">
          <p className="text-lg text-center ">Hi, I am Nayden Naydenov, freelance developer based in Bulgaria. I specialise in creating interactive and immersive websites using next.js and three.js. Currently in my final year of Computer Science degree I am looking for remote job opportunities to gain more experience.</p>
